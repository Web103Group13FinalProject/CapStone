    ...
    return (
            ...
            <div id="HeaderContainer" className={scrolled ? 'scrolled' : ''}>
                ...
                {showMobileView ? (
                        ...
                        {showMobileMenu ? (
                            <div id='MobileMenu'>
                                <div id="MobileMenuItems" className={showMobileMenuItems ? 'opened' : ''}>
                                    <div id="MobileNewMealItemContainer">
                                        <Link id="MobileNewMealItem" href="/new">Create Post</Link>
                                    </div>
                    ...
                    <div id="MenuContainer">
                        <div id="MenuItems">
                            <div id="NewMealItemContainer">
                                <Link id="NewMealItem" href="/new">Create Post</Link>
                            </div>
        ...
        <style>
            {`
                ...
                #NewMealItem, #UsernameItem, #LoginItem { 
                    font-size: 20px;
                    color: white; 
                ...
                #NewMealItem:hover, #UsernameItem:hover, #LoginItem:hover { opacity: 0.7; }
                #MobileMenuContainer {
                    display: flex;
                    position: relative;
                    width: 100px;
                ...
                #MobileNewMealItem, #MobileUsernameItem, #MobileLoginItem { 
                    font-size: 20px;
                    color: white; 
                    text-decoration: none; 
                    font-family: InterSemi; 
                ...
                #MobileNewMealItem:hover, #MobileUserItem:hover, #MobileLoginItem:hover { opacity: 0.7; }
