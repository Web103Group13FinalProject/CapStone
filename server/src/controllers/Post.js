...
export class PostController {
    ...
    createPost(req, res, post) {
        try {
            ...
            console.log(error);
            return res.status(500).json({error: "error occured when creating for post"});
        }
    };

    updatePostById(req, res, post) {
        try {
            ...
            console.log(error);
            return res.status(500).json({error: "error occured when updating for post"});
        }
    };
    ...
    deletePostById(req, res) {
        try {
            ...
            console.log(error);
            return res.status(500).json({error: "error occured when deleting post"});
        }
    };
